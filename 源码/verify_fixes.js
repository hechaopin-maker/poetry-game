...
(async () => {
  ...
  async function takeScreenshot(name) {
    const path = `/Users/hechaopin_claw/.openclaw/workspace-life/screenshots/${name}.png`;
  ...
  try {
    ...
    await page.locator('text=返回主页').first().click().catch(() => {});
    await page.waitForTimeout(1000);
    ...
    if (await feihuaStartBtn.isVisible({ timeout: 2000 }).catch(() => false)) {
