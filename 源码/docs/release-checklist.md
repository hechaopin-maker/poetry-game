...
// ==================== 项目信息 ====================
// 项目名称：古诗词大挑战 (poetry-game)
// 技术栈：纯前端 HTML/CSS/JS，LocalStorage 持久化
// 部署平台：Cloudflare Pages
// 线上地址：https://poetry-game.pages.dev
// GitHub：https://github.com/hechaopin-maker/poetry-game
// 当前版本：2.0.0（五阶段渐进式现代化后）
